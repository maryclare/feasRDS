                                   ...
                                   K)
{
  ...
  alphaLG <- (muG - alphaGG*muG*muG/mu - alphaBWG*muG*muBW/mu - alphaBMG*muG*muBM/mu)*mu/(muL*muG)
  alphaBWL <- (muBW - alphaBWG*muG*muBW/mu - alphaBWB*(muBW + muBM)*muBW/mu)*mu/(muBW*muL)
  alphaBML <- (muL - alphaLG*muL*muG/mu - alphaLL*muL*muL/mu - alphaBWL*muL*muBW/mu)*mu/(muL*muBM)
